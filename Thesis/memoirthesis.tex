...
\documentclass[a4paper,12pt,leqno,openbib]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
\usepackage[english, romanian]{babel}		%For languages characters and hyphenation
...
%
\theoremstyle{plain}
\newtheorem{teo}{Teoremă}[chapter]
\theoremstyle{plain}
\newtheorem{prop}{Propoziție}[chapter]
\theoremstyle{plain}
\theoremstyle{definition}
\newtheorem{dfn}{Definiție}[chapter]
\theoremstyle{plain}
\newtheorem{lema}{Lemă}[chapter]
\theoremstyle{plain}
\newtheorem{cor}{Corolar}[chapter]
\theoremstyle{plain}
\newtheorem{res}{Rezultat}[chapter]
\newtheorem{obs}{Observație}[chapter]
\newtheorem{ex}{Exemplu}[chapter]
\newtheorem{dem}{Demonstrație}[chapter]
%
