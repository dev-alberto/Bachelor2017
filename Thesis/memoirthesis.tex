...
\theoremstyle{plain}
\newtheorem{prop}{Propozitie}[chapter]
\theoremstyle{plain}
\theoremstyle{definition}
\newtheorem{dfn}{Definitie}[chapter]
\theoremstyle{plain}
\newtheorem{lema}{Lema}[chapter]
\theoremstyle{plain}
\newtheorem{cor}{Corolar}[chapter]
\theoremstyle{plain}
\newtheorem{res}{Resultat}[chapter]
\newtheorem{obs}{Observatie}[chapter]
\newtheorem{ex}{Exemplu}[chapter]
\newtheorem{dem}{Demonstratie}[chapter]
%
