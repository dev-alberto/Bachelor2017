...
# joint_mul_affine_192 = JointMultiplicationScalarPerformanceTest(1000, P192, [2**5, 2**32])
# joint_mul_affine_192Big = JointMultiplicationScalarPerformanceTest(1000, P192, [2**128, 2**192])
#
# joint_mul_jacobi_192 = JointMultiplicationScalarPerformanceTest(1000, P192, [2**5, 2**32], jacobi=True)
# joint_mul_jacobi_192Big = JointMultiplicationScalarPerformanceTest(1000, P192, [2**128, 2**192], jacobi=True)
#
# joint_mul_affine_384 = JointMultiplicationScalarPerformanceTest(1000, P384, [2**5, 2**32])
# joint_mul_affine_384Big = JointMultiplicationScalarPerformanceTest(1000, P384, [2**128, 2**192])
#
